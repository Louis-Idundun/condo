package com.condo.condo.exceptions;
...
public class FlexExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(FlexisafException.class)
    public ApiResponse<String> handleFlexException(FlexisafException exception){
